...
Credits_Staff::               db "      #MON"                 ; "ポケットモンスター"
                            IF DEF(_GOLD)
                            next "  Goldene Edition"
                            ELIF DEF(_SILVER)
                            next "  Silberne Edition"
                            ENDC
                            next "       Staff@"
Credits_Director::            db "      Leitung@"            ; "エグゼクティブ　ディレクター@"
Credits_SubDirector::         db "     Assistenz@"
Credits_Programmers::         db "   Programmierer@"           ; "プログラム@"
Credits_GraphicsDirector::    db "       Grafik@"        ; "グラフィック　ディレクター@"
Credits_MonsterDesign::       db "   Monster-Design@"         ; "#　デザイン@"
Credits_GraphicsDesign::      db "   Grafik-Design@"         ; "グラフィック　デザイン@"
Credits_Music::               db "       Musik@"              ; "おんがく@"
Credits_SoundEffects::        db "   Sound-Effekte@"          ; "サウンド　エフェクト@"
Credits_GameDesign::          db "    Spiel-Design@"           ; "ゲームデザイン@"
Credits_GameScenario::        db "   Spiel-Szenario@"          ; "シナりオ@"
Credits_ToolProgramming::     db "Tool-Programmierung@"        ; "ツール　プログラム@"
Credits_ParametricDesign::    db "  Parametr. Design@"        ; "パラメーター　せってい@"
Credits_ScriptDesign::        db "       Script@"            ; "スクりプト　せってい@"
Credits_MapDataDesign::       db "   Karten-Inhalt@"         ; "マップデータ　せってい@"
Credits_MapDesign::           db "   Karten-Design@"           ; "マップ　デザイン@"
Credits_ProductTesting::      db "  Product-Testing@"         ; "デバッグプレイ@"
Credits_SpecialThanks::       db "  Besonderer Dank@"         ; "スぺシャルサンクス@"
Credits_Producers::           db "    Produzenten@"            ; "プロデューサー@"
Credits_ExecutiveProducer::   db "    Ausführender"           ; "エグゼクティブ　プロデューサー@"
                            next "     Produzent@"
Credits_UsVersionStaff::      db "   Deutsches Team@"
Credits_UsCoordination::      db "Europa-Koordination@"
Credits_TextTranslation::     db "   Deutscher Text@"
Credits_PaadTesting::         db "  Product-Testing@"
