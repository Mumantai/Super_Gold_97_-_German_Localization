...
MomPhoneKobanText:
	...
	para "Hast du schon den"
	line "DRACHENSCHLUND"
	cont "gesehen?"

	para "Klingt gruselig!"
	done
...
MomPhoneAmamiText:
	...
	para "Ich war noch nie"
	line "auf den INSELN."
	para "Klingt aufregend!"
	done
